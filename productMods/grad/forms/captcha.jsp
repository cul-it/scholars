...
<%
 ...
 // Original URL: http://www.jroller.com/mlconnor/entry/simple_captcha_jsp
 //========================================================
 ...
 try {
   ...
   Color backgroundColor = new Color(68,126,128);
   Color borderColor = Color.black;
   Color textColor = Color.white;
   Color circleColor = new Color(200,200,200);
   Font textFont = new Font("Arial", Font.PLAIN, paramInt(request, "fontSize", 24));
   int charsToPrint = 6;
   int width = paramInt(request, "width", 160);
