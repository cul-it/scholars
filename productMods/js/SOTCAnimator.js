...
function  slideDiagonally(elementId, headerElement, containerElement)
{
   ...
   {     
      ...
      element.up = true;
      element.down = false;
      child[0].innerHTML = '<ul><li>+ Help</li><li>Improve</li><li>VIVO</li></ul>';
   ...
   else
   {
      ...
      element.down = true;
      element.up = false;
      child[0].innerHTML = '<ul><li style="margin-top:18px">- Close</li></ul>';
	  element.style.borderWidth = "1px";
   }
}
function resizeContainerElement() {
		document.getElementById("panelContainer").style.height = "56px";
        document.getElementById("panelContainer").style.width = "98px";
}
