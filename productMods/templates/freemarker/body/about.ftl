<div class="row scholars-row">
	...
	<div class="pageGroupBody" id="acknowledgementText">
		<p style="margin-left:30px;margin-right:50px">The Scholars@Cornell project was initiated and resides in the Cornell University Library, with support from the Office of the Provost. Technology development and disciplinary content entry are directed by the Scholars@Cornell project team, whose members are:
			<ul style="margin-left:30px;margin-right:60px;list-style:none">
	...
	<div class="pageGroupBody" id="acknowledgementText">
		<p style="margin: 0 50px 0 30px;font-size:12px">
			Photo credits:
			<ul style="margin: -2px 60px 0 30px;font-size:12px">
				<li>Central campus at night and during summer; AD White Reading Room &mdash; Robert Barker / Cornell Marketing Group</li>
				<li style="line-height: 14px;">Tjaden Hall and the Arts Quad &mdash; Jason Koski / Cornell Marketing Group</li>
			</ul>
		</p>
	</div>
</div>
