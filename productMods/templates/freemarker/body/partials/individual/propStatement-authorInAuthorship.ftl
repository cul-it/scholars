...
<#else>
    <#local citationDetails>
        <#if statement.subclass??>
            <#if statement.subclass?contains("Article") || statement.subclass?contains("IAO_0000013")>
                <#if statement.journal?? || statement.freeTextTitle??>
                    <em>${statement.journal!statement.freeTextTitle!}</em>.&nbsp;
