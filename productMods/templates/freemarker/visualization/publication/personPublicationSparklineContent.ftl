                                ...
                                <#if sparklineVO.shortVisMode>
                                    ...
                                    */
                                    ...
                                    if ( !onlyUnknownYearPublications ) {
                                        ...
                                        $('#${sparklineContainerID} td.sparkline_number').text(totalPubs + " in the last 10 full").css("font-size",".95em").attr("class", "grey");
                                    ...
                                    <#-- tlw72: there was a bug in this code where the wrong text displayed if the individual only had 
                                          undated publications; this, beginning with the if statement at line 150, fixes that bug. 
                                          Can't figure out why the "In case that there" comment appears twice and whether the following 
                                          20 lines of code should have originally been here or needs to be duplicated.
                                    -->
                                    var totalPubs = onlyUnknownYearPublications ? unknownYearPublicationCounts : renderedSparks;

                                    $('#${sparklineContainerID} td.sparkline_number').html(totalPubs + "  total <img class='infoIcon' src='" + infoIconSrc + "' height='16px' width='16px' alt='information icon' title='These numbers are based solely on publications that have been loaded into this VIVO application. If this is your profile, you can enter additional publications below.' />").css("font-weight", "bold").css("font-size",".85em").attr("class", "grey");
                                   }
