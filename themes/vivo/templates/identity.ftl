...
<div id="cu-identity"> <!--  generated by vivo/productMods/themes/vivo/templates/page/partials/identity.ftl -->
    <div id="cu-logo">
        <a id="insignia-link" class="clean" href="http://www.cornell.edu/" title="Cornell University"><img src="${urls.siteIcons}/layout/cu_logo.gif" alt="Cornell University" width="283" height="76" border="0" /></a> 
