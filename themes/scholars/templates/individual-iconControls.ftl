...
<a href="http://pollack.research.engineering.cornell.edu/" title="View the departmental page" target="_blank"><img id="webIcon" title="Click to view websites" width="32px" src="${urls.base}/themes/scholars/images/websites-icon.png" alt="Click to view website/s" style="margin-left:6px"/></a>
