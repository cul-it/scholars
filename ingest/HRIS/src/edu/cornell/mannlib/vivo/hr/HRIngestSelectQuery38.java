...
public class HRIngestSelectQuery38 {
    ...
    static final Logger logger = Logger.getLogger(HRIngestSelectQuery38.class);
	...
	public static Model CreateHRISDiff(boolean readFromFile) throws Exception {
	...
	public static Model CheckForNetID(Model mdlHRISDiff) throws Exception {
		...
		try {	
			...
			NodeIterator netIditer = mdlHRISDiff.listObjects(  );
			...
			mdlNotAlreadyInVIVO = mdlHRISDiff.difference(mdlAlreadyInVIVO);
			...
			String vivonetIdFileName = fileRDFPath + "vivoNetIdMatchRDF.nt";
	...
	public static void main(String[] args) throws Exception {
		...
		Model mdlHRISDiff = CreateHRISDiff(ReadFromFile);
