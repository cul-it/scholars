...
public class HRIngestSelectQuery23 {
	...
	public static Model ReadRdf(String filename, String basename, String readformat) throws IOException {
	...
	public static void main(String[] args) throws Exception {
		...
		Model mdlHRISMatch = ReadRdf(HRISMatchfilename, readnamespace, readfileformat);
		...
		WriteRdf(HRISMatchFileName, mdlHRISDiff, "N-TRIPLE");
		...
		try {  // begin try for gathering new person RDF
			...
			while (iter.hasNext(  )) {
				...
				// remove after testing complete
				//System.out.println(qStrNewPersonRDF);
				...
				//Model mdlAllHRIS = MakeNewModelCONSTRUCT(qStrNewPersonRDF);          
				// execute queries and populate model
				...
				try {  // create CONSTRUCT rdf and push to HRIS model 
					...
					NodeIterator dataiter = mdlNewPersonRDF.listObjects( );
			...
			String allNewHRISFileName  = fileRDFPath + "newPersonRDFADD.nt";
			WriteRdf(allNewHRISFileName, mdlAllNewPeopleRDF, "N3");
