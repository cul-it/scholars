	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			while (personiter.hasNext(  )) {
				...
				try {
					StmtIterator testiter = mdlOnePersonVIVORDF.listStatements();
					...
					while (testiter.hasNext(  )) {
						...
						*/
						...
						if ((strPredicate).equals("http://www.w3.org/2000/01/rdf-schema#label")) {
							...
							//System.out.print("\n\n");
							CorrectedVIVOPersonRDF.add(subject, predicate, newLabel);
					...
					logger.error("Rats.  Something happened while looking at VIVO person statements. Error" + e + "\n");
				} finally {
					logger.debug("done with VIVO statements for " + PersonId + ".");
				}
