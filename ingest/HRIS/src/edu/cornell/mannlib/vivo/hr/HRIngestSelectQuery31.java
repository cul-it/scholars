...
public class HRIngestSelectQuery31 {
    ...
    static final Logger logger = Logger.getLogger(HRIngestSelectQuery31.class);
	...
	public static String ConcatQueryString(String args[]) throws Exception {
		String qStrConcat = "";
		try {
		logger.debug("made it to concat method");
		...
		logger.debug("here is the string" + qStrConcat);
		} catch (Exception e) {
