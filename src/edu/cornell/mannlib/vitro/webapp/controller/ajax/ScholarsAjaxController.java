 ...
 */
public class ScholarsAjaxController extends VitroAjaxController {
	private static final Log log = LogFactory
			.getLog(ScholarsAjaxController.class);
	...
	protected void doRequest(VitroRequest vreq, HttpServletResponse resp)
		...
		try {
			...
			if ("getHomePageDataGetters".equals(function)) {
				new HomePageDataGetters(this, vreq, resp).processRequest();
			}
			else {
