 ...
 * TODO
 * 
 * THIS CORNELL-SPECIFIC VERSION PROVIDES FUZZY MATCHING FOR THE NETID. GET RID
 * OF THIS AS SOON AS IS PRACTICAL.
 * 
 * ----------------------------------------------------------------------------
 */
...
public class IndividualDaoJena extends JenaBaseDao implements IndividualDao {
	 ...
	 * TODO
	 * 
	 * For now, Cornell ignores the lack of a matching property. It uses a
	 * hard-coded property instead, and a fuzzy matching scheme.
	 * 
	 * Eventually, we'd like to get rid of this special file and use a straight
	 * match instead.
	 */
