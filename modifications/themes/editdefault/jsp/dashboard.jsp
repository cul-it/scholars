...
<ul id="dashboardNavigation">
    ...
    <li>
        ...
        <ul class="dashboardCategories">
            <li class="dashboardProperty"><a href="${geographicalResearchArea}">geographical research area</a></li>
            <li class="dashboardProperty"><a title="disabled">international statement (disabled)</a></li>
            <li class="dashboardProperty"><a title="disabled">collaboration with (disabled)</a></li>
        </ul>
    </li>       
    <li>
        <h2><a href="#">Instruction &amp; Academics</a></h2>
        <ul class="dashboardCategories">
            <li class="dashboardProperty"><a title="disabled">teaching areas (disabled)</a></li>
            <li class="dashboardProperty"><a title="disabled">for-credit courses (disabled)</a></li>
            <li class="dashboardProperty"><a title="disabled">new courses planned (disabled)</a></li>
            <li class="dashboardProperty"><a title="disabled">academic initiatives (disabled)</a></li>
    ...
    <li>
        ...
        <ul class="dashboardCategories">
            <li class="dashboardProperty"><a title="disabled">outreach statement (disabled)</a></li>
            <li class="dashboardProperty"><a title="disabled">impact statement (disabled)</a></li>
            <li class="dashboardProperty"><a title="disabled">public service (disabled)</a></li>
            <li class="dashboardProperty"><a title="disabled">organizational advising or consulting (disabled)</a></li>
            <li class="dashboardProperty"><a title="disabled">non-credit instruction (disabled)</a></li>
            <li class="dashboardProperty"><a title="disabled">mediaexpertise (disabled)</a></li>
        </ul>
    </li>
    <li>
        ...
        <ul class="dashboardCategories">
            ...
            <li class="dashboardProperty"><a title="disabled">professional background (disabled)</a></li>
            <li class="dashboardProperty"><a title="disabled">awards &amp; distinctions (disabled)</a></li>
            <li class="dashboardProperty"><a title="disabled">university title (disabled)</a></li>
            <li class="dashboardProperty"><a title="disabled">working title (disabled)</a></li>
        </ul>
    </li>
    <li>
        ...
        <ul class="dashboardCategories">
            ...
            <li class="dashboardProperty"><a title="disabled">performer of (disabled)</a></li>
            <li class="dashboardProperty"><a title="disabled">creator of (disabled)</a></li>
            <li class="dashboardProperty"><a title="disabled">contributor of (disabled)</a></li>
        </ul>
    </li>
    <li>
        ...
        <ul class="dashboardCategories">
            ...
            <li class="dashboardProperty"><a title="disabled">office address (disabled)</a></li>
            <li class="dashboardProperty"><a title="disabled">office phone (disabled)</a></li>
            <li class="dashboardProperty"><a title="disabled">email address (disabled)</a></li>
